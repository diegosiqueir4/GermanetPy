...
class CompoundInfo:
    ...
    def __init__(self, modifier1, head, modifier1property=None, modifier1category=None, modifier2=None,
        ...
        """
        This class stores information about a special linguistic entity in German - a compound. A compound consists
        of two constituents, a modifier and a head. The head will always be noun, the modifier can stem from a noun,
        ...
        :param modifier1: A String that represents the modifier (or one possibility). Example: 'Laufband' - modifier1:
        'laufen'
        :param head: A String that represents the head. Example: 'Laufband' - head: 'Band'
        :param modifier1property: A String that represents the property of the first modifier variant, e.g. if it is
        an Affixoid
